...
# =========================================================
# RUN SLIDER TEST (HUMAN-LIKE MOVEMENT)
# =========================================================

def run_slider_test_human(page):

    print()
    print("========================================")
    print("STARTING SLIDER TEST (HUMAN-LIKE)")
    print("========================================")
    ...
    # -----------------------------------------
    # Drag LEFT -> RIGHT (HUMAN-LIKE MOVEMENT)
    # -----------------------------------------

    print("Dragging slider (human-like movement with jitter)...")

    steps = 30  # Fewer steps for longer duration

    for i in range(1, steps + 1):

        progress = i / steps

        # Add some randomness to velocity (human-like acceleration/deceleration)
        human_progress = progress + random.uniform(-0.02, 0.02)
        human_progress = max(0, min(1, human_progress))
        ...
        # Add Y-axis jitter (human hand tremor)
        ...
        # Variable timing (human-like inconsistency) - longer delays
    ...
    if "Verification Successful" in text_content or "verified" in text_content.lower() or "Successful" in text_content:
        print("RESULT: VERIFICATION PASSED (Human-like movement accepted)")
    else:
        print("RESULT: VERIFICATION FAILED (Human-like movement rejected)")
    print("========================================")
